...
function CControlWnd:ctor(scene)
	...
	--设置位图
	self.m_btChiHu=ccui.Button:create("res/game/BT_HU.png")
		:move(0,0)
		:setTag(CControlWnd.IDC_CHIHU)
    --:setEnabled(false)
		:addTo(self)
    :addTouchEventListener(btcallback)
	self.m_btGiveUp=ccui.Button:create("res/game/BT_QU_XIAO.png")
		:move(0,0)
	...
	self.m_btChiShang=ccui.Button:create("res/game/BT_CHI_SHANG.png")
		:move(0,0)
		:setTag(CControlWnd.IDC_CHI_SHANG)
		--:setEnabled(false)
		:addTo(self)
		:addTouchEventListener(btcallback)
	self.m_btChiZhong=ccui.Button:create("res/game/BT_CHI_ZHONG.png")
		:move(0,0)
		:setTag(CControlWnd.IDC_CHI_ZHONG)
    --:setEnabled(false)
		:addTo(self)
    :addTouchEventListener(btcallback)
	self.m_btChiXia=ccui.Button:create("res/game/BT_CHI_XIA.png")
		:move(0,0)
		:setTag(CControlWnd.IDC_CHI_XIA)
    --:setEnabled(false)
		:addTo(self)
    :addTouchEventListener(btcallback)
	self.m_btPeng=ccui.Button:create("res/game/BT_PENG.png")
		:move(0,0)
		:setTag(CControlWnd.IDC_PENG)
    --:setEnabled(false)
		:addTo(self)
    :addTouchEventListener(btcallback)
	self.m_btGang=ccui.Button:create("res/game/BT_GANG.png")
		:move(0,0)
...
--鼠标消息
function CControlWnd:OnLButtonDown(nFlags,nFlags)
	...
	if self.m_cbCurrentItem ~= 0xFF then
		...
		--类型子项
		for i=0,GameLogic.table_leng(cbItemKind)-1,1 do
			if (bit:_and(self.m_cbActionMask,cbItemKind[i])~=0) and (self.m_cbCurrentItem==(cbIndex=cbIndex+1)) then
		...
		--杠牌子项
		for i=0,GameLogic.table_leng(self.m_cbGangCard)-1,1 do
			if (self.m_cbGangCard[i]~=0) and (self.m_cbCurrentItem==(cbIndex=cbIndex+1)) then
				GameLayer:OnCardOperate( GameLogic.WIK_GANG,self.m_cbGangCard[i] )
				return
			end
		end
