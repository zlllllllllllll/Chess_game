...
function CardExtractor:ctor(scene)
	...
	self.m_CardCtrl[4]=CardControl:create_CCardControl(self)
	...
	self.m_CardCtrl[4]:SetCardData(nil,0,0)
	self.m_CardCtrl[4]:SetPositively(true)
	self.m_CardCtrl[4]:SetDisplayItem(true)
...
function CardExtractor:OnPaint()
	...
	self.m_CardCtrl[4]:DrawCardControl()
...
function CardExtractor:OnInitDialog()
	...
	self.m_CardCtrl[1]:SetBenchmarkPos(nWidth/2-80,nHeight + 5,CardControl.enXCenter,CardControl.enYBottom)
	self.m_CardCtrl[2]:SetBenchmarkPos(nWidth/2-80,nHeight + 105,CardControl.enXCenter,CardControl.enYBottom)
	self.m_CardCtrl[3]:SetBenchmarkPos(nWidth/2-80,nHeight + 205,CardControl.enXCenter,CardControl.enYBottom)
	self.m_CardCtrl[4]:SetBenchmarkPos(nWidth/2-80,nHeight + 305,CardControl.enXCenter,CardControl.enYBottom)
	...
	self.m_CardCtrl[3]:SetCardData(byCardData[3], 9, 0)
	self.m_CardCtrl[4]:SetCardData(byCardData[4], 7, 0)
